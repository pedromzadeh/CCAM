...
def dynamic_velocity_aligning(cell):
    """
    Computes the change in polarity angle at the next time step according to the velocity-aligning model, where the timescale of alignment scales by the speed of the cell, i.e. tau ~ 1/Jv.
...
def static_velocity_aligning(cell, tau):
    """
    Computes the change in polarity angle at the next time step according to the velocity-aligning model, where the timescale of alignment is constant.
...
def FFCR(cells, i, t, n_collision):
    """
    Computes the change in polarity of the cell for the next time step as governed by the front-front contact repolarization mechanism. 
